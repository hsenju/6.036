...
theta, theta_0 = p1. # Enter your algorithm call here e.g. p1.avg_passive_aggressive(train_feature_matrix, train_labels, T,l)

dummy_labels, test_texts = p1.read_data('submit.tsv')
test_feature_matrix = p1.extract_feature_vectors(test_texts, dictionary)

print "Making predictions..."
predictions = p1.classify(test_feature_matrix, theta_0, average_theta)
